...
namespace MyPiggyBank.Core.Service
{
    public interface ICyclicOperationsService
    {
        ...
        PagedList<CyclicOperationResponse> GetCyclicOperations(CyclicOperationGetRequest response, Guid userId);
        Task SaveCyclicOperation(CyclicOperationSaveRequest source);
    }
}